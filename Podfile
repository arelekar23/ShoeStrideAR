platform :ios, '12.0'
target 'StepVision' do
	pod 'SCCameraKit', '1.29.0'
	pod 'SCCameraKitReferenceUI', '1.29.0'
	pod 'SCCameraKitReferenceSwiftUI', '1.29.0'
	pod 'SnapSDK', '2.4.0', :subspecs => ['SCSDKCreativeKit']

	target 'StepVisionTests' do
		inherit! :search_paths
	end

	# Only include Push to Device in non-App Store configurations using `, :configurations => ['Debug']`, eg:
  # pod 'SCCameraKitPushToDeviceExtension', '1.29.0', :configurations => ['Debug']
	pod 'SCCameraKitBaseExtension', '1.29.0'
	pod 'SCCameraKitPushToDeviceExtension', '1.29.0'
	pod 'SCCameraKitLoginKitAuth', '1.29.0'
