...
#if (EYE_SHARPEN)
{
float l9_7=sc_Camera.aspect*0.00078125001;
float l9_8=sc_Camera.aspect*(-0.00078125001);
...
#if (ADD_NOISE)
{
float l9_10=(fract(sin(dot(varPackedTex.xy,vec2(12.9898,78.233002)))*43758.547)-0.5)*0.033333335;
...
#if (EYE_WHITENING)
{
l9_5=l9_2.z*eyeWhiteningIntensity;
}
#else
{
l9_5=0.0;
